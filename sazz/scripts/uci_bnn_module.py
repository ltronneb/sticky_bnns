...
Usage (same shape as uci_bnn.py):
    ...
    python -m sazz.scripts.uci_bnn_module --datasets hernandez
    python -m sazz.scripts.uci_bnn_module --datasets boston --splits 0
    python -m sazz.scripts.uci_bnn_module --datasets energy --include-nuts
"""
