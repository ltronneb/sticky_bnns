...
# ===========================================================================
# Adam warm-start: find x_ref and diagonal Sigma_inv
# ===========================================================================
...
# ) -> tuple[Tensor, Tensor]:
#     """
#     Run Adam to find x_ref (MAP estimate) and a diagonal precision matrix
#     Sigma_inv estimated from the empirical Fisher at the MAP.

#     Parameters
#     ----------
#     energy_fn : callable (beta: Tensor) -> scalar Tensor
...
#         Number of gradient samples for the diagonal Fisher estimate.
#         Set to 0 to use a simple squared-gradient approximation instead.

#     Returns
#     -------
#     x_ref : Tensor [D]
#     Sigma_inv : Tensor [D, D]  (diagonal)
#     """
...
#     # --- Diagonal precision via squared gradients at MAP ---
#     # This is a diagonal Gauss-Newton / empirical Fisher approximation:
#     #   Sigma_inv_ii ≈ (dE/dbeta_i)^2 evaluated at x_ref,
...
#     # Clip to avoid degenerate reference
#     #diag_prec = grad_sq.clamp(min=1e-4, max=1e4)
#     diag_prec = grad_sq.clamp(min=1, max=1e4)
